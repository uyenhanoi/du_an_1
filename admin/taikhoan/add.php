      ...
      <section class="function-prds">
        ...
        <div class="form-function-wrapper">
          ...
          <form action="index.php?act=addtk" method="post" class="form-function" enctype="multipart/form-data">
            ...
            <div class="input-group">
                    Tên đăng nhập<br>
                    <input type="text" name="user" id="" class="input__content">
            </div>
                    <div class="input-group">
                    Mật khẩu <br>
                    <input type="text" name="pass" id="" class="input__content">
                    </div>
                    <div class="input-group">
                    Email <br>
                    <input style="width: 100%;border: 1px #CCC solid;padding: 10px;border-radius: 5px;" type="email" name="email" id="">
                    </div>
                    <div class="input-group">
                    Địa chỉ <br>
                    <input type="text" name="address" id="" class="input__content">
                    </div>
                    <div class="input-group">
                    Điện thoại <br>
                    <input type="text" name="tel" id="" class="input__content">
                    </div>
            <span></span>
           
             <input type="submit" value="THÊM MỚI" name="themmoi" id="" class="btn-implement btn-action">
